...
`figma-to-react` performs the lookup as step 2 of its workflow, before any markup is written. The result lives in memory for the duration of the call — there is no persistence across invocations.
