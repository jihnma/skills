...
| `vrtThreshold` | number | per-package | Diff ratio threshold (0–1) for VRT. Default `0.05`. Calibration by story size: see `fe-design-check` SKILL.md `## Threshold guidance`. |
